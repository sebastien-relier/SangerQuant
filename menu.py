...
class FileMenu:
    ...
    def export_raw_data(self):
        ...
        self.exporter = Exporter(self.main.data)
        self.exporter.show()
...
class AnalysisMenu:
    ...
    def __init__(self, menubar, main):
        ...
        self.quantAction = QAction(QIcon("://icons/batch_quantification.png"), "&Batch quantification", self.menubar)
        self.exportsubseqAction = QAction(QIcon("://icons/batch_svg_export.png"), "&Batch export", self.menubar)
