...
class SampleList(QListWidget):
    ...
    def __init__(self, window, items = None):
        ...
        row = items.index(self.window.main.samples.selected_sample)
    ...
    def _update_preview_table(self, headers, data):
        #helper functions
        self.window.preview_table.rename_headers(headers)
        self.window.preview_table.reset_table_values()
        self.window.preview_table.update_table(data)
    ...
    def show_peak_height(self, data):
        ...
        self._update_preview_table(["BaseCalled", "Phred", "G", "A", "T", "C"], res)
    ...
    def show_traces(self, data):
        ...
        for g, a, t, c in zip(trace["G"], trace["A"], trace["T"], trace["C"]):
            res.append([g, a, t, c])
        self._update_preview_table(["G", "A", "T", "C"], res)
