...
class CompareQuality(QWidget):
    ...
    def __init__(self, data):
        ...
        # -- create window title -- #
        self.setWindowTitle("TraceQ - Sequence Quality Comparison")
        self.resize(600,400)
...
class ExportButton(QPushButton):
   ...
   ''' creates a button to export data ''' 
   ...
   def __init__(self, window):
        ...
        self.clicked.connect(self.export_data)
   ...
   def export_data(self):
        ...
        if file_dialog.exec():
            ...
            exporter = pg.exporters.ImageExporter(self.window.plot.plot_area.getPlotItem())
