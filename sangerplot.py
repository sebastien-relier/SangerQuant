...
from PyQt5.QtWidgets import QGridLayout, QWidget, QGraphicsSimpleTextItem
...
class SangerTraces(pg.PlotWidget):
    ...
    def mouse_clicked(self, mouseClickEvent):
        ...
        self.quantification_area.peak_pos = where
...
class QuantificationArea:
    ...
    def get_position_of_quant(self):
        
        current_seq = self.window.seq[self.peak_pos -10: self.peak_pos + 10]
